...
- (a) valor em reais, digitado caso a caso *(é o que a planilha faz hoje)*
...
- (b) é um valor digitado, negociado caso a caso *(é o que a planilha faz)*
...
### P6 · Arredondamento
Não há `ARRED`/`ROUND` na planilha — o Excel calcula em ponto flutuante e só *exibe* 2 casas. Isso funciona enquanto as quantidades são inteiras, mas quebra com quantidade fracionada (ex.: `3,5 m² × R$ 187,33`).
...
- (a) manter assim — seções numeradas livres, algumas com preço, outras não *(fiel à planilha)*
...
### P11 · Unidades
O único registro de unidades é um comentário de célula: *"Unidade (UND, M, M² etc.)"* — e o orçamento usa `UNID.`.
...
- **Inscrição Estadual** da AA Montagens (o campo I.E. existe para o *cliente*, mas não para a empresa) — tem? Precisa sair no PDF?
